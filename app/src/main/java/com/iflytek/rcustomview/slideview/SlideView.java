package com.iflytek.rcustomview.slideview;
...
public class SlideView extends View {
    ...
    public SlideView(Context context, AttributeSet attrs) {
        ...
        mSlider = typeArray.getResourceId(R.styleable.SlideView_slider, R.drawable.ic_launcher_home);
        ...
        mGradientColors = new int[] {Color.argb(255, 180, 180, 180),
                Color.argb(255, 180, 180, 180), Color.argb(255, 255, 255, 255)};
