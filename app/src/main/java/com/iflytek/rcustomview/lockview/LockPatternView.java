package com.iflytek.rcustomview.lockview;
...
public class LockPatternView extends View {
	...
	private float mDiameterFactor = 0.05f; // TODO: move to attrs
	...
	public LockPatternView(Context context, AttributeSet attrs) {
		...
		mBitmapCircleDefault = getBitmapFor(R.drawable.lock_screen_ico_gray);
		mBitmapCircleGreen = getBitmapFor(R.drawable.lock_screen_ico_check);
		mBitmapCircleRed = getBitmapFor(R.drawable.lock_screen_ico_red);
	...
	protected void onDraw(Canvas canvas) {
		...
		if (drawPath) {
			...
			if (mPatternDisplayMode == DisplayMode.Wrong)
				mPathPaint.setColor(Color.rgb(255, 77, 85));
			else
				mPathPaint.setColor(Color.rgb(75, 158, 255));
